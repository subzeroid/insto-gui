...
class ReleaseGatesTests(unittest.TestCase):
    ...
    def test_failed_gate_writes_fail_line_and_the_trap_preserves_exit_1(self):
        """A failing gate records one fail line, and the cleanup EXIT trap
        re-raises the gate's exit code rather than its own."""
